...
namespace PLCRead.Core.Infrastructure
{
    public class ProFileProvider : PhysicalFileProvider, IProFileProvider
    {

        #region Ctor
        public ProFileProvider(IWebHostEnvironment webHostEnvironment)
