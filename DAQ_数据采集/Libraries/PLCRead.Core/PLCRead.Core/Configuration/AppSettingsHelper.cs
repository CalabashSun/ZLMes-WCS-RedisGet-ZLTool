...
namespace PLCRead.Core.Configuration
{
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IProFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(PLCConfigurationDefaults.AppSettingsFilePath);
