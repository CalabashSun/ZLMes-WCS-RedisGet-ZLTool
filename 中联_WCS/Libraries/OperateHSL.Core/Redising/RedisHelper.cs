...
namespace OperateHSL.Core.Redising
{
    /// <summary>
    /// Redis操作
    /// </summary>
    public class RedisHelper
    {
        ...
        public RedisHelper(int dbNum, string readWriteHosts)
        {
            ...
            _conn = string.IsNullOrWhiteSpace(readWriteHosts) ?
                    RedisConnectHelper.Instance :
                    RedisConnectHelper.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        /// <returns>保存多个键值</returns>
        public bool SetKeyValueString(List<KeyValuePair<RedisKey, RedisValue>> keyValues)
        {
        ...
        /// <returns></returns>
        public bool SetKeyValueString<T>(string key, T obj, TimeSpan? expiry = default(TimeSpan?))
        {
            key = AddSysCustomKey(key);
        ...
        /// <returns></returns>
        public RedisValue[] GetStrValueList(List<string> listKey)
        {
        ...
        /// <param name="expiry">过期时间</param>
        /// <returns></returns>
        public async Task<bool> SetStrValueAsync(string key, string value, TimeSpan? expiry = default(TimeSpan?))
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="keyValues">键值对</param>
        /// <returns></returns>
        public async Task<bool> SetStrValueAsync(List<KeyValuePair<RedisKey, RedisValue>> keyValues)
        {
        ...
        /// <param name="expiry"></param>
        /// <returns></returns>
        public async Task<bool> SetStrValueAsync<T>(string key, T obj, TimeSpan? expiry = default(TimeSpan?))
        {
            key = AddSysCustomKey(key);
            string json = ConvertJson(obj);
        ...
        /// <param name="key">Redis Key</param>
        /// <returns></returns>
        public async Task<string> GetStrValueAsync(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="listKey">Redis Key集合</param>
        /// <returns></returns>
        public async Task<RedisValue[]> GetStrValueAsync(List<string> listKey)
        {
            List<string> newKeys = listKey.Select(AddSysCustomKey).ToList();
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<T> GetStrValueAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        {
            var prefixKey = CustomKey ?? RedisConnectHelper.SysCustomKey;
